...
[![简体中文 badge](https://img.shields.io/badge/%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87-Simplified%20Chinese-blue)](/ml/3.行业观察/3.6-Prompts 精选)
...
[示例——视频目标检测](/ml/3.行业观察/examples/super_experts_gpt)
...
> 历史配图未随仓库保留：imgs/gpt_connect.jpg
...
[示例——CAN 完整对话](/ml/3.行业观察/examples/gpt4_CAN_coder)
...
> 历史配图未随仓库保留：imgs/ai_function.jpg
...
GPT-4 食用为佳，完整示例如下：
[完整示例——写作智能机器人书籍](/ml/3.行业观察/examples/GPT_Generate_A_book)
...
> 历史配图未随仓库保留：imgs/chatgpt_xhs_title_gen.jpg

### 模仿小红书的风格

    小红书的风格是：很吸引眼球的标题，每个段落都加 emoji, 最后加一些 tag。请用小红书风格: 描写去了上海东方明珠。

> 历史配图未随仓库保留：imgs/chatgpt_xhs.jpg
...
> 历史配图未随仓库保留：imgs/ascii_rabbit.jpg
...
> 历史配图未随仓库保留：imgs/img_url_math.png
...
> 历史配图未随仓库保留：imgs/image_gpt_cat.jpg
...
> 历史配图未随仓库保留：imgs/mj_child_pic.jpg
...
[完整示例——数学问题求解](/ml/3.行业观察/examples/gpt_math_solver)

> 历史配图未随仓库保留：imgs/math_slover.jpg
...
> 历史配图未随仓库保留：imgs/domain_gpt.jpg
...
- Midjourney 中英双语辞典（原始 PDF 未随仓库保留）
