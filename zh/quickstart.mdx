...
<Card title="核心概念" icon="book" href="/concepts/overview">
  了解 Specs、Tasks 和 Workspace 是怎么配合工作的。
</Card>

<Card title="写好 Spec" icon="pencil" href="/guides/specs">
  让 AI 真正遵循规范的写作技巧。
</Card>

<Card title="命令参考" icon="terminal" href="/guides/commands">
  常用工作流的 Slash 命令。
</Card>

<Card title="多 Agent 协作" icon="users" href="/guides/multi-agent">
  并行运行多个 AI Agent。
</Card>
